...
const GLOBAL_EARLY_HINT_LINKS = [
  '</css/style.css?v=13.7>; rel=preload; as=style',
  '</css/minimal.css?v=13.7>; rel=preload; as=style',
  '</js/theme-init.js?v=13.7>; rel=preload; as=script',
  '</js/twemoji.min.js?v=13.7>; rel=preload; as=script',
  '</js/whatsapp-emojis.js?v=13.7>; rel=preload; as=script',
  '</js/app.js?v=13.7>; rel=preload; as=script',
...
const MESSAGES_EARLY_HINT_LINKS = [
  '</css/messages.css?v=13.7>; rel=preload; as=style',
  '</css/calling.css?v=13.7>; rel=preload; as=style',
  '</js/messages.js?v=13.7>; rel=preload; as=script',
  '</js/calling.js?v=13.7>; rel=preload; as=script'
];
