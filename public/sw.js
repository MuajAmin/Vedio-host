...
const CACHE_NAME = 'videohost-v12.7';

// Static assets to pre-cache on install
const PRECACHE_ASSETS = [
    '/css/style.css?v=12.7',
    '/css/minimal.css?v=12.7',
    '/css/messages.css?v=12.7',
    '/css/calling.css?v=12.7',
    '/js/theme-init.js?v=12.7',
    '/js/twemoji.min.js?v=12.7',
    '/js/app.js?v=12.7',
    '/js/messages.js?v=12.7',
    '/js/watchTogether.js?v=12.7',
    '/js/calling.js?v=12.7',
    '/css/icon-192.png',
    '/css/icon-512.png',
    '/manifest.json'
];
