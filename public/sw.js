...
const CACHE_NAME = 'videohost-v11.2';

// Static assets to pre-cache on install
const PRECACHE_ASSETS = [
    '/css/style.css?v=11.2',
    '/css/minimal.css?v=11.2',
    '/css/messages.css?v=11.2',
    '/css/calling.css?v=11.2',
    '/js/theme-init.js?v=11.2',
    '/js/app.js?v=11.2',
    '/js/messages.js?v=11.2',
    '/js/watchTogether.js?v=11.2',
    '/js/calling.js?v=11.2',
    '/css/icon-192.png',
    '/css/icon-512.png',
    '/manifest.json'
];
