...
const PRECACHE_ASSETS = [
    ...
    '/css/minimal.css?v=10.8',
    '/css/messages.css?v=10.8',
    '/css/calling.css?v=10.8',
    '/js/theme-init.js?v=10.8',
    '/js/app.js?v=10.8',
    '/js/messages.js?v=10.8',
    '/js/watchTogether.js?v=10.8',
    '/js/calling.js?v=10.8',
    '/css/icon-192.png',
    '/css/icon-512.png',
    '/manifest.json'
];
