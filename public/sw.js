...
const CACHE_NAME = 'videohost-v13.7';
const MEDIA_CACHE_NAME = 'videohost-media-v3';
const MAX_MEDIA_CACHE_ITEMS = 100;

// Static assets to pre-cache on install
const PRECACHE_ASSETS = [
    '/css/style.css?v=13.7',
    '/css/minimal.css?v=13.7',
    '/css/messages.css?v=13.7',
    '/css/calling.css?v=13.7',
    '/js/theme-init.js?v=13.7',
    '/js/twemoji.min.js?v=13.7',
    '/js/whatsapp-emojis.js?v=13.7',
    '/js/app.js?v=13.7',
    '/js/messages.js?v=13.7',
    '/js/watchTogether.js?v=13.7',
    '/js/calling.js?v=13.7',
    '/css/icon-192.png',
    '/css/icon-512.png',
    '/manifest.json'
];
