...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isHajeraMode && !prefersReducedMotion) {
        ...
        if (loveQuoteEl) {
            const quotes = [
                'আমাদের প্রাইভেট সিনেমা রুমে তোমাকে স্বাগতম ✨',
                'তোমার জন্য এই সব ভিডিও সাজিয়ে রেখেছি 🎬',
                'প্রতিটি ভিডিও আমাকে আমাদের ভালোবাসার কথা মনে করিয়ে দেয় 💫',
                'তুমি দেখলেই আমার মন ভালো হয়ে যায় 🌸',
                'আমাদের স্মৃতি, আমাদের মুহূর্ত, আমাদের ভালোবাসা 💖',
                'তোমার মিষ্টি হাসি আমার সবচেয়ে প্রিয় ভিডিও 💕',
                'ভালোবাসা দিয়ে তৈরি, শুধু তোমার জন্য 🌹',
